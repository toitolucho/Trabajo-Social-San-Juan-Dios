...
import org.quarkbit.trabajosocialsanjuan.controller.CFIngresosTipos;
import org.quarkbit.trabajosocialsanjuan.controller.CFPropiedadesTipos;

public class FPropiedadesTipos extends JDialog {
	...
	private JTable jTablePropiedadTipo;
	public CFPropiedadesTipos control;
	/**
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FPropiedadesTipos frame = new FPropiedadesTipos(null);
...
//	{
//		control = new CFIngresosTipos(this);
...
//	}
	 ...
	 * Create the frame.
	 */
	public FPropiedadesTipos(JFrame owner) {
		super(owner, true);
		setTitle("Tipos de Controles de Consulta");
		setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		setBounds(100, 100, 682, 294);
		...
		pnlControles.setPreferredSize(new Dimension(340, 10));
		...
		JLabel lblPropiedadTipo = new JLabel("Fuente de Ingreso:");
		lblPropiedadTipo.setPreferredSize(new Dimension(100, 14));
		pnlControles.add(lblPropiedadTipo);
		...
		jTablePropiedadTipo = new JTable();
		jTablePropiedadTipo.setModel(new DefaultTableModel(
			new Object[][] {
				{"123", "Padres"},
			},
			new String[] {
		...
		scrollPane.setViewportView(jTablePropiedadTipo);
		
		control = new CFPropiedadesTipos(this);
		control.onLoad();
	}
	...
	public JTable getjTablePropiedadTipo() {
		return jTablePropiedadTipo;
	}
