...
import org.quarkbit.trabajosocialsanjuan.controller.CFEmpleos;

public class FEmpleos extends JDialog {
	...
	private JTable jTableEmpleo;
	public CFEmpleos control;
...
//	}
	...
	public FEmpleos(JFrame owner) {
		...
		pnlControles.setPreferredSize(new Dimension(290, 10));
...
//		pnlControles.add(txtDescripcion);
		...
		jTableEmpleo = new JTable();
		jTableEmpleo.setModel(new DefaultTableModel(
			new Object[][] {
				{"123", "Padres"},
			},
			new String[] {
		...
		scrollPane.setViewportView(jTableEmpleo);
