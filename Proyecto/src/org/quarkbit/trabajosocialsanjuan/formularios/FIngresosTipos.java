...
public class FIngresosTipos extends JDialog {
	...
	private JTable jTableIngresoTipo;
	public CFIngresosTipos control;
	/**
...
//			public void run() {
//				try {
//					FIngresosTipos frame = new FIngresosTipos();
...
//	}
	 ...
	 * Create the frame.
	 */
	public FIngresosTipos(JFrame owner) {
		super(owner, true);
		setTitle("Fuentes de Ingreso");
		setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		setBounds(100, 100, 631, 294);
		...
		JLabel lblIngresoTipo = new JLabel("Fuente de Ingreso:");
		lblIngresoTipo.setPreferredSize(new Dimension(100, 14));
		pnlControles.add(lblIngresoTipo);
		...
		jTableIngresoTipo = new JTable();
		jTableIngresoTipo.setModel(new DefaultTableModel(
			new Object[][] {
				{"123", "Padres"},
			},
			new String[] {
		...
		scrollPane.setViewportView(jTableIngresoTipo);
	...
	public JTable getjTableIngresoTipo() {
		return jTableIngresoTipo;
	}
